    ...
    public class ChatHub(UserManager<AppUser> userManager, AppDbContext context) : Hub
    {
        ...
        private async Task<IEnumerable<OnlineUserDto>> GetAllUsers()
        {
            ...
            var users = await userManager
                .Users.Select(u => new OnlineUserDto
                {
                    Id = u.Id,
                    UserName = u.UserName,
                    FullName = u.FullName,
        ...
        public async Task SendMessage(MessageRequestDto message)
        {
            ...
            await Clients.User(receiverId!).SendAsync("ReceiveNewMessage", msg);
        }
        ...
        public async Task NotifyTyping(string receiverUsername)
        {
            ...
            var connectionId = onlineUsers
                .Values.FirstOrDefault(x => x.UserName == receiverUsername)
                ?.ConnectionId;
        ...
        public async Task LoadMessages(string receiverId, int pageNumber = 1)
        {
            ...
            List<MessageResponseDto> messages = await context
                .Messages.Where(x =>
            ...
            await Clients.User(currentUser.Id).SendAsync("ReceiverMessageList", messages);
        }
    }
}
